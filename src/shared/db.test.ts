	...
	describe("visits table", () => {
		...
		it("queries by domain index", async () => {
			await db.visits.bulkAdd([
				{ url: "https://a.com/1", title: "A1", domain: "a.com", timestamp: 1, duration: 0, scrollDepth: 0 },
				{ url: "https://b.com/1", title: "B1", domain: "b.com", timestamp: 2, duration: 0, scrollDepth: 0 },
				{ url: "https://a.com/2", title: "A2", domain: "a.com", timestamp: 3, duration: 0, scrollDepth: 0 },
			]);
		...
		it("queries by timestamp range", async () => {
			const now = Date.now();
			await db.visits.bulkAdd([
				{ url: "https://a.com/1", title: "Old", domain: "a.com", timestamp: now - 100000, duration: 0, scrollDepth: 0 },
				{ url: "https://a.com/2", title: "Mid", domain: "a.com", timestamp: now - 50000, duration: 0, scrollDepth: 0 },
				{ url: "https://a.com/3", title: "New", domain: "a.com", timestamp: now, duration: 0, scrollDepth: 0 },
			]);
		...
		it("queries by compound [domain+timestamp] index", async () => {
			const now = Date.now();
			await db.visits.bulkAdd([
				{ url: "https://a.com/1", title: "A", domain: "a.com", timestamp: now - 100000, duration: 0, scrollDepth: 0 },
				{ url: "https://a.com/2", title: "A", domain: "a.com", timestamp: now, duration: 0, scrollDepth: 0 },
				{ url: "https://b.com/1", title: "B", domain: "b.com", timestamp: now, duration: 0, scrollDepth: 0 },
			]);
		...
		it("queries by sessionId", async () => {
			await db.visits.bulkAdd([
				{ url: "https://a.com/1", title: "A", domain: "a.com", timestamp: 1, duration: 0, scrollDepth: 0, sessionId: 1 },
				{ url: "https://a.com/2", title: "B", domain: "a.com", timestamp: 2, duration: 0, scrollDepth: 0, sessionId: 2 },
				{ url: "https://a.com/3", title: "C", domain: "a.com", timestamp: 3, duration: 0, scrollDepth: 0, sessionId: 1 },
			]);
		...
		it("updates a visit", async () => {
			const id = await db.visits.add({
				...
				timestamp: Date.now(), duration: 0, scrollDepth: 0,
			});
	...
	describe("sessions table", () => {
		...
		it("updates session visit count", async () => {
			const id = await db.sessions.add({
				startTime: Date.now(), endTime: Date.now(), visitCount: 1,
			});

			await db.sessions.update(id, { visitCount: 5, endTime: Date.now() + 1000 });
